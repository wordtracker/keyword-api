...
"use strict";var SwaggerToHar=require("./swagger-to-har.js"),HTTPSnippet=require("httpsnippet"),getEndpointSnippets=function(e,t,r,i,n){void 0===n&&(n={});var a=SwaggerToHar.getEndpoint(e,t,r,n),o=new HTTPSnippet(a),p=[];for(var g in i){var s=formatTarget(i[g]);if(!s)throw new Error("Invalid target: "+i[g]);p.push({id:i[g],title:s.title,content:o.convert(s.language,void 0!==s.library?s.library:null)})}return{method:a.method,url:a.url,description:a.description,resource:getResourceName(a.url),snippets:p}},getSwaggerSnippets=function(e,t){var r=SwaggerToHar.getAll(e),i=[];for(var n in r){var a=r[n],o=new HTTPSnippet(a.har),p=[];for(var g in t){var s=formatTarget(t[g]);if(!s)throw new Error("Invalid target: "+t[g]);p.push({id:t[g],title:s.title,content:o.convert(s.language,void 0!==s.library?s.library:null)})}i.push({method:a.method,url:a.url,description:a.description,resource:getResourceName(a.url),snippets:p})}return i.sort(function(e,t){return e.resource<t.resource?-1:e.resource>t.resource?1:getMethodOrder(e.method.toLowerCase(),t.method.toLowerCase())}),i},getMethodOrder=function(e,t){var r=["get","post","put","delete","patch"];return-1===r.indexOf(e)?1:-1===r.indexOf(t)?-1:r.indexOf(e)<r.indexOf(t)?-1:r.indexOf(e)>r.indexOf(t)?1:0},getResourceName=function(e){for(var t=e.split("/"),r=t.length-1;r>=0;r--){var i=t[r];if(""!==i&&!/^{/.test(i))return i}},formatTarget=function(e){var t=e.split("_")[0],r=capitalizeFirstLetter(t),i=e.split("_")[1],n=HTTPSnippet.availableTargets(),a=!1,o=!1;for(var p in n){var g=n[p];if(t===g.key)if(a=!0,void 0===i)i=g.default,o=!0;else for(var s in g.clients){if(i===g.clients[s].key){o=!0;break}}}return a&&o?{title:void 0!==i?r+" + "+capitalizeFirstLetter(i):r,language:t,library:i}:null},capitalizeFirstLetter=function(e){return e.charAt(0).toUpperCase()+e.slice(1)};if(module.exports={getSwaggerSnippets:getSwaggerSnippets,getEndpointSnippets:getEndpointSnippets},"undefined"!=typeof window){var SwaggerSnippet=window.SwaggerSnippet||{};SwaggerSnippet={getSwaggerSnippets:getSwaggerSnippets,getEndpointSnippets:getEndpointSnippets},window.SwaggerSnippet=SwaggerSnippet}

},{"./swagger-to-har.js":167,"httpsnippet":81}],2:[function(require,module,exports){
...
},{"./cache":3,"./compile":7,"./compile/async":4,"./compile/error_classes":5,"./compile/formats":6,"./compile/resolve":8,"./compile/rules":9,"./compile/schema_obj":10,"./compile/util":12,"./data":13,"./keyword":40,"./refs/data.json":41,"./refs/json-schema-draft-07.json":43,"fast-json-stable-stringify":54}],3:[function(require,module,exports){
...
},{"../dotjs/validate":39,"./error_classes":5,"./resolve":8,"./util":12,"fast-deep-equal":53,"fast-json-stable-stringify":54}],8:[function(require,module,exports){
...
},{"./schema_obj":10,"./util":12,"fast-deep-equal":53,"json-schema-traverse":129,"uri-js":161}],9:[function(require,module,exports){
...
},{"./ucs2length":11,"fast-deep-equal":53}],13:[function(require,module,exports){
...
"use strict";module.exports=function(e,a,r){var s=" ",t=e.level,l=e.dataLevel,h=e.schema[a],o=e.schemaPath+e.util.getProperty(a),c=e.errSchemaPath+"/"+a,i=!e.opts.allErrors,m="data"+(l||""),v="valid"+t,u="errs__"+t,d=e.util.copy(e);d.level++;var n="valid"+d.level,P=e.schema.then,p=e.schema.else,E=void 0!==P&&e.util.schemaHasRules(P,e.RULES.all),f=void 0!==p&&e.util.schemaHasRules(p,e.RULES.all),R=d.baseId;if(E||f){var S;d.createErrors=!1,d.schema=h,d.schemaPath=o,d.errSchemaPath=c,s+=" var "+u+" = errors; var "+v+" = true;  ";var g=e.compositeRule;e.compositeRule=d.compositeRule=!0,s+="  "+e.validate(d)+" ",d.baseId=R,d.createErrors=!0,s+="  errors = "+u+"; if (vErrors !== null) { if ("+u+") vErrors.length = "+u+"; else vErrors = null; }  ",e.compositeRule=d.compositeRule=g,E?(s+=" if ("+n+") {  ",d.schema=e.schema.then,d.schemaPath=e.schemaPath+".then",d.errSchemaPath=e.errSchemaPath+"/then",s+="  "+e.validate(d)+" ",d.baseId=R,s+=" "+v+" = "+n+"; ",E&&f?s+=" var "+(S="ifClause"+t)+" = 'then'; ":S="'then'",s+=" } ",f&&(s+=" else { ")):s+=" if (!"+n+") { ",f&&(d.schema=e.schema.else,d.schemaPath=e.schemaPath+".else",d.errSchemaPath=e.errSchemaPath+"/else",s+="  "+e.validate(d)+" ",d.baseId=R,s+=" "+v+" = "+n+"; ",E&&f?s+=" var "+(S="ifClause"+t)+" = 'else'; ":S="'else'",s+=" } "),s+=" if (!"+v+") {   var err =   ",!1!==e.createErrors?(s+=" { keyword: 'if' , dataPath: (dataPath || '') + "+e.errorPath+" , schemaPath: "+e.util.toQuotedString(c)+" , params: { failingKeyword: "+S+" } ",!1!==e.opts.messages&&(s+=" , message: 'should match \"' + "+S+" + '\" schema' "),e.opts.verbose&&(s+=" , schema: validate.schema"+o+" , parentSchema: validate.schema"+e.schemaPath+" , data: "+m+" "),s+=" } "):s+=" {} ",s+=";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; ",!e.compositeRule&&i&&(e.async?s+=" throw new ValidationError(vErrors); ":s+=" validate.errors = vErrors; return false; "),s+=" }   ",i&&(s+=" else { "),s=e.util.cleanUpCode(s)}else i&&(s+=" if (true) { ");return s};
...
"use strict";module.exports=function(e,r,a){var s=" ",l=e.level,t=e.dataLevel,o=e.schema[r],i=e.schemaPath+e.util.getProperty(r),h=e.errSchemaPath+"/"+r,c=!e.opts.allErrors,v="data"+(t||""),m="valid"+l,u="errs__"+l,n=e.util.copy(e),d="";n.level++;var p="valid"+n.level,f=n.baseId,E="prevValid"+l,P="passingSchemas"+l;s+="var "+u+" = errors , "+E+" = false , "+m+" = false , "+P+" = null; ";var g=e.compositeRule;e.compositeRule=n.compositeRule=!0;var R=o;if(R)for(var S,y=-1,b=R.length-1;y<b;)S=R[y+=1],e.util.schemaHasRules(S,e.RULES.all)?(n.schema=S,n.schemaPath=i+"["+y+"]",n.errSchemaPath=h+"/"+y,s+="  "+e.validate(n)+" ",n.baseId=f):s+=" var "+p+" = true; ",y&&(s+=" if ("+p+" && "+E+") { "+m+" = false; "+P+" = ["+P+", "+y+"]; } else { ",d+="}"),s+=" if ("+p+") { "+m+" = "+E+" = true; "+P+" = "+y+"; }";return e.compositeRule=n.compositeRule=g,s+=d+"if (!"+m+") {   var err =   ",!1!==e.createErrors?(s+=" { keyword: 'oneOf' , dataPath: (dataPath || '') + "+e.errorPath+" , schemaPath: "+e.util.toQuotedString(h)+" , params: { passingSchemas: "+P+" } ",!1!==e.opts.messages&&(s+=" , message: 'should match exactly one schema in oneOf' "),e.opts.verbose&&(s+=" , schema: validate.schema"+i+" , parentSchema: validate.schema"+e.schemaPath+" , data: "+v+" "),s+=" } "):s+=" {} ",s+=";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; ",!e.compositeRule&&c&&(e.async?s+=" throw new ValidationError(vErrors); ":s+=" validate.errors = vErrors; return false; "),s+="} else {  errors = "+u+"; if (vErrors !== null) { if ("+u+") vErrors.length = "+u+"; else vErrors = null; }",e.opts.allErrors&&(s+=" } "),s};
...
"use strict";module.exports=function(e,r,a){var t=" ",s=e.level,o=e.dataLevel,i=e.schema[r],l=e.schemaPath+e.util.getProperty(r),h=e.errSchemaPath+"/"+r,p=!e.opts.allErrors,d="data"+(o||""),P="errs__"+s,n=e.util.copy(e),c="";n.level++;var u="valid"+n.level,v="key"+s,f="idx"+s,m=n.dataLevel=e.dataLevel+1,g="data"+m,y="dataProperties"+s,b=Object.keys(i||{}),S=e.schema.patternProperties||{},E=Object.keys(S),O=e.schema.additionalProperties,R=b.length||E.length,j=!1===O,k="object"==typeof O&&Object.keys(O).length,w=e.opts.removeAdditional,Q=j||k||w,_=e.opts.ownProperties,A=e.baseId,D=e.schema.required;if(D&&(!e.opts.$data||!D.$data)&&D.length<e.opts.loopRequired)var q=e.util.toHash(D);if(t+="var "+P+" = errors;var "+u+" = true;",_&&(t+=" var "+y+" = undefined;"),Q){if(t+=_?" "+y+" = "+y+" || Object.keys("+d+"); for (var "+f+"=0; "+f+"<"+y+".length; "+f+"++) { var "+v+" = "+y+"["+f+"]; ":" for (var "+v+" in "+d+") { ",R){if(t+=" var isAdditional"+s+" = !(false ",b.length)if(b.length>8)t+=" || validate.schema"+l+".hasOwnProperty("+v+") ";else{var x=b;if(x)for(var I=-1,L=x.length-1;I<L;)K=x[I+=1],t+=" || "+v+" == "+e.util.toQuotedString(K)+" "}if(E.length){var H=E;if(H)for(var U=-1,F=H.length-1;U<F;)se=H[U+=1],t+=" || "+e.usePattern(se)+".test("+v+") "}t+=" ); if (isAdditional"+s+") { "}if("all"==w)t+=" delete "+d+"["+v+"]; ";else{var V=e.errorPath,$="' + "+v+" + '";if(e.opts._errorDataPathProperty&&(e.errorPath=e.util.getPathExpr(e.errorPath,v,e.opts.jsonPointers)),j)if(w)t+=" delete "+d+"["+v+"]; ";else{t+=" "+u+" = false; ";var C=h;h=e.errSchemaPath+"/additionalProperties",(re=re||[]).push(t),t="",!1!==e.createErrors?(t+=" { keyword: 'additionalProperties' , dataPath: (dataPath || '') + "+e.errorPath+" , schemaPath: "+e.util.toQuotedString(h)+" , params: { additionalProperty: '"+$+"' } ",!1!==e.opts.messages&&(t+=" , message: '",e.opts._errorDataPathProperty?t+="is an invalid additional property":t+="should NOT have additional properties",t+="' "),e.opts.verbose&&(t+=" , schema: false , parentSchema: validate.schema"+e.schemaPath+" , data: "+d+" "),t+=" } "):t+=" {} ";var N=t;t=re.pop(),!e.compositeRule&&p?e.async?t+=" throw new ValidationError(["+N+"]); ":t+=" validate.errors = ["+N+"]; return false; ":t+=" var err = "+N+";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; ",h=C,p&&(t+=" break; ")}else if(k)if("failing"==w){t+=" var "+P+" = errors;  ";var T=e.compositeRule;e.compositeRule=n.compositeRule=!0,n.schema=O,n.schemaPath=e.schemaPath+".additionalProperties",n.errSchemaPath=e.errSchemaPath+"/additionalProperties",n.errorPath=e.opts._errorDataPathProperty?e.errorPath:e.util.getPathExpr(e.errorPath,v,e.opts.jsonPointers);var z=d+"["+v+"]";n.dataPathArr[m]=v;var B=e.validate(n);n.baseId=A,e.util.varOccurences(B,g)<2?t+=" "+e.util.varReplace(B,g,z)+" ":t+=" var "+g+" = "+z+"; "+B+" ",t+=" if (!"+u+") { errors = "+P+"; if (validate.errors !== null) { if (errors) validate.errors.length = errors; else validate.errors = null; } delete "+d+"["+v+"]; }  ",e.compositeRule=n.compositeRule=T}else{n.schema=O,n.schemaPath=e.schemaPath+".additionalProperties",n.errSchemaPath=e.errSchemaPath+"/additionalProperties",n.errorPath=e.opts._errorDataPathProperty?e.errorPath:e.util.getPathExpr(e.errorPath,v,e.opts.jsonPointers);z=d+"["+v+"]";n.dataPathArr[m]=v;B=e.validate(n);n.baseId=A,e.util.varOccurences(B,g)<2?t+=" "+e.util.varReplace(B,g,z)+" ":t+=" var "+g+" = "+z+"; "+B+" ",p&&(t+=" if (!"+u+") break; ")}e.errorPath=V}R&&(t+=" } "),t+=" }  ",p&&(t+=" if ("+u+") { ",c+="}")}var G=e.opts.useDefaults&&!e.compositeRule;if(b.length){var J=b;if(J)for(var K,M=-1,W=J.length-1;M<W;){var X=i[K=J[M+=1]];if(e.util.schemaHasRules(X,e.RULES.all)){var Y=e.util.getProperty(K),Z=(z=d+Y,G&&void 0!==X.default);n.schema=X,n.schemaPath=l+Y,n.errSchemaPath=h+"/"+e.util.escapeFragment(K),n.errorPath=e.util.getPath(e.errorPath,K,e.opts.jsonPointers),n.dataPathArr[m]=e.util.toQuotedString(K);B=e.validate(n);if(n.baseId=A,e.util.varOccurences(B,g)<2){B=e.util.varReplace(B,g,z);var ee=z}else{ee=g;t+=" var "+g+" = "+z+"; "}if(Z)t+=" "+B+" ";else{if(q&&q[K]){t+=" if ( "+ee+" === undefined ",_&&(t+=" || ! Object.prototype.hasOwnProperty.call("+d+", '"+e.util.escapeQuotes(K)+"') "),t+=") { "+u+" = false; ";V=e.errorPath,C=h;var re,ae=e.util.escapeQuotes(K);e.opts._errorDataPathProperty&&(e.errorPath=e.util.getPath(V,K,e.opts.jsonPointers)),h=e.errSchemaPath+"/required",(re=re||[]).push(t),t="",!1!==e.createErrors?(t+=" { keyword: 'required' , dataPath: (dataPath || '') + "+e.errorPath+" , schemaPath: "+e.util.toQuotedString(h)+" , params: { missingProperty: '"+ae+"' } ",!1!==e.opts.messages&&(t+=" , message: '",e.opts._errorDataPathProperty?t+="is a required property":t+="should have required property \\'"+ae+"\\'",t+="' "),e.opts.verbose&&(t+=" , schema: validate.schema"+l+" , parentSchema: validate.schema"+e.schemaPath+" , data: "+d+" "),t+=" } "):t+=" {} ";N=t;t=re.pop(),!e.compositeRule&&p?e.async?t+=" throw new ValidationError(["+N+"]); ":t+=" validate.errors = ["+N+"]; return false; ":t+=" var err = "+N+";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; ",h=C,e.errorPath=V,t+=" } else { "}else p?(t+=" if ( "+ee+" === undefined ",_&&(t+=" || ! Object.prototype.hasOwnProperty.call("+d+", '"+e.util.escapeQuotes(K)+"') "),t+=") { "+u+" = true; } else { "):(t+=" if ("+ee+" !== undefined ",_&&(t+=" &&   Object.prototype.hasOwnProperty.call("+d+", '"+e.util.escapeQuotes(K)+"') "),t+=" ) { ");t+=" "+B+" } "}}p&&(t+=" if ("+u+") { ",c+="}")}}if(E.length){var te=E;if(te)for(var se,oe=-1,ie=te.length-1;oe<ie;){X=S[se=te[oe+=1]];if(e.util.schemaHasRules(X,e.RULES.all)){n.schema=X,n.schemaPath=e.schemaPath+".patternProperties"+e.util.getProperty(se),n.errSchemaPath=e.errSchemaPath+"/patternProperties/"+e.util.escapeFragment(se),t+=_?" "+y+" = "+y+" || Object.keys("+d+"); for (var "+f+"=0; "+f+"<"+y+".length; "+f+"++) { var "+v+" = "+y+"["+f+"]; ":" for (var "+v+" in "+d+") { ",t+=" if ("+e.usePattern(se)+".test("+v+")) { ",n.errorPath=e.util.getPathExpr(e.errorPath,v,e.opts.jsonPointers);z=d+"["+v+"]";n.dataPathArr[m]=v;B=e.validate(n);n.baseId=A,e.util.varOccurences(B,g)<2?t+=" "+e.util.varReplace(B,g,z)+" ":t+=" var "+g+" = "+z+"; "+B+" ",p&&(t+=" if (!"+u+") break; "),t+=" } ",p&&(t+=" else "+u+" = true; "),t+=" }  ",p&&(t+=" if ("+u+") { ",c+="}")}}}return p&&(t+=" "+c+" if ("+P+" == errors) {"),t=e.util.cleanUpCode(t)};

},{}],35:[function(require,module,exports){
"use strict";module.exports=function(r,e,a){var t=" ",s=r.level,o=r.dataLevel,l=r.schema[e],i=r.schemaPath+r.util.getProperty(e),v=r.errSchemaPath+"/"+e,c=!r.opts.allErrors,p="data"+(o||""),m="errs__"+s,d=r.util.copy(r);d.level++;var h="valid"+d.level;if(t+="var "+m+" = errors;",r.util.schemaHasRules(l,r.RULES.all)){d.schema=l,d.schemaPath=i,d.errSchemaPath=v;var u="key"+s,n="idx"+s,E="i"+s,P="' + "+u+" + '",f="data"+(d.dataLevel=r.dataLevel+1),y="dataProperties"+s,R=r.opts.ownProperties,b=r.baseId;R&&(t+=" var "+y+" = undefined; "),t+=R?" "+y+" = "+y+" || Object.keys("+p+"); for (var "+n+"=0; "+n+"<"+y+".length; "+n+"++) { var "+u+" = "+y+"["+n+"]; ":" for (var "+u+" in "+p+") { ",t+=" var startErrs"+s+" = errors; ";var g=u,S=r.compositeRule;r.compositeRule=d.compositeRule=!0;var k=r.validate(d);d.baseId=b,r.util.varOccurences(k,f)<2?t+=" "+r.util.varReplace(k,f,g)+" ":t+=" var "+f+" = "+g+"; "+k+" ",r.compositeRule=d.compositeRule=S,t+=" if (!"+h+") { for (var "+E+"=startErrs"+s+"; "+E+"<errors; "+E+"++) { vErrors["+E+"].propertyName = "+u+"; }   var err =   ",!1!==r.createErrors?(t+=" { keyword: 'propertyNames' , dataPath: (dataPath || '') + "+r.errorPath+" , schemaPath: "+r.util.toQuotedString(v)+" , params: { propertyName: '"+P+"' } ",!1!==r.opts.messages&&(t+=" , message: 'property name \\'"+P+"\\' is invalid' "),r.opts.verbose&&(t+=" , schema: validate.schema"+i+" , parentSchema: validate.schema"+r.schemaPath+" , data: "+p+" "),t+=" } "):t+=" {} ",t+=";  if (vErrors === null) vErrors = [err]; else vErrors.push(err); errors++; ",!r.compositeRule&&c&&(r.async?t+=" throw new ValidationError(vErrors); ":t+=" validate.errors = vErrors; return false; "),c&&(t+=" break; "),t+=" } }"}return c&&(t+="  if ("+m+" == errors) {"),t=r.util.cleanUpCode(t)};
...
"use strict";var IDENTIFIER=/^[a-z_$][a-z0-9_$-]*$/i,customRuleCode=require("./dotjs/custom"),metaSchema=require("./refs/json-schema-draft-07.json");module.exports={add:addKeyword,get:getKeyword,remove:removeKeyword,validate:validateKeyword};var definitionSchema={definitions:{simpleTypes:metaSchema.definitions.simpleTypes},type:"object",dependencies:{schema:["validate"],$data:["validate"],statements:["inline"],valid:{not:{required:["macro"]}}},properties:{type:metaSchema.properties.type,schema:{type:"boolean"},statements:{type:"boolean"},dependencies:{type:"array",items:{type:"string"}},metaSchema:{type:"object"},modifying:{type:"boolean"},valid:{type:"boolean"},$data:{type:"boolean"},async:{type:"boolean"},errors:{anyOf:[{type:"boolean"},{const:"full"}]}}};function addKeyword(e,t){var r=this.RULES;if(r.keywords[e])throw new Error("Keyword "+e+" is already defined");if(!IDENTIFIER.test(e))throw new Error("Keyword "+e+" is not a valid identifier");if(t){this.validateKeyword(t,!0);var a=t.type;if(Array.isArray(a))for(var o=0;o<a.length;o++)s(e,a[o],t);else s(e,a,t);var i=t.metaSchema;i&&(t.$data&&this._opts.$data&&(i={anyOf:[i,{$ref:"https://raw.githubusercontent.com/epoberezkin/ajv/master/lib/refs/data.json#"}]}),t.validateSchema=this.compile(i,!0))}function s(e,t,a){for(var o,i=0;i<r.length;i++){var s=r[i];if(s.type==t){o=s;break}}o||(o={type:t,rules:[]},r.push(o));var d={keyword:e,definition:a,custom:!0,code:customRuleCode,implements:a.implements};o.rules.push(d),r.custom[e]=d}return r.keywords[e]=r.all[e]=!0,this}function getKeyword(e){var t=this.RULES.custom[e];return t?t.definition:this.RULES.keywords[e]||!1}function removeKeyword(e){var t=this.RULES;delete t.keywords[e],delete t.all[e],delete t.custom[e];for(var r=0;r<t.length;r++)for(var a=t[r].rules,o=0;o<a.length;o++)if(a[o].keyword==e){a.splice(o,1);break}return this}function validateKeyword(e,t){validateKeyword.errors=null;var r=this._validateKeyword=this._validateKeyword||this.compile(definitionSchema,!0);if(r(e))return!0;if(validateKeyword.errors=r.errors,t)throw new Error("custom keyword definition is invalid: "+this.errorsText(r.errors));return!1}

},{"./dotjs/custom":23,"./refs/json-schema-draft-07.json":43}],41:[function(require,module,exports){
module.exports={
...
},{"base64-js":44,"buffer":46,"ieee754":125}],47:[function(require,module,exports){
(function (Buffer){
...
},{"../../is-buffer/index.js":127}],48:[function(require,module,exports){
(function (process){
...
},{"./debug":49,"_process":135}],49:[function(require,module,exports){
...
},{"ms":131}],50:[function(require,module,exports){
...
},{"stream":156}],51:[function(require,module,exports){
...
},{"_process":135,"buffer":46,"duplexer":50,"from":56,"map-stream":130,"pause-stream":133,"split":155,"stream":156,"stream-combiner":157,"through":159}],52:[function(require,module,exports){
...
},{"_process":135,"stream":156}],57:[function(require,module,exports){
module.exports={
...
},{"./afterRequest.json":57,"./beforeRequest.json":58,"./browser.json":59,"./cache.json":60,"./content.json":61,"./cookie.json":62,"./creator.json":63,"./entry.json":64,"./har.json":65,"./header.json":66,"./log.json":68,"./page.json":69,"./pageTimings.json":70,"./postData.json":71,"./query.json":72,"./request.json":73,"./response.json":74,"./timings.json":75}],68:[function(require,module,exports){
module.exports={
  "$id": "log.json#",
  "$schema": "http://json-schema.org/draft-06/schema#",
  "type": "object",
...
},{"./error":77,"ajv":2,"ajv/lib/refs/json-schema-draft-06.json":42,"har-schema":67}],77:[function(require,module,exports){
...
"use strict";var util=require("util"),CodeBuilder=function(t,i){this.code=[],this.indentation=t,this.lineJoin=i||"\n"};CodeBuilder.prototype.buildLine=function(t,i){var e="",n=2;if("[object String]"===Object.prototype.toString.call(t))n=1,i=t,t=0;else if(null===t)return null;for(;t;)e+=this.indentation,t--;var o=Array.prototype.slice.call(arguments,n,arguments.length);return o.unshift(e+i),util.format.apply(this,o)},CodeBuilder.prototype.unshift=function(){return this.code.unshift(this.buildLine.apply(this,arguments)),this},CodeBuilder.prototype.push=function(){return this.code.push(this.buildLine.apply(this,arguments)),this},CodeBuilder.prototype.blank=function(){return this.code.push(null),this},CodeBuilder.prototype.join=function(){return this.code.join(this.lineJoin)},module.exports=CodeBuilder;

},{"util":166}],79:[function(require,module,exports){
"use strict";module.exports=function(e,n){if(void 0===e[n.name])return e[n.name]=n.value,e;var a=[e[n.name],n.value];return e[n.name]=a,e};

},{}],80:[function(require,module,exports){
"use strict";var util=require("util");module.exports={quote:function(e){return/^[a-z0-9-_\/.@%^=:]+$/i.test(e)?e:util.format("'%s'",e.replace(/'/g,"'\\''"))},escape:function(e){return e.replace(/\r/g,"\\r").replace(/\n/g,"\\n")}};

},{"util":166}],81:[function(require,module,exports){
"use strict";var debug=require("debug")("httpsnippet"),es=require("event-stream"),MultiPartForm=require("form-data"),qs=require("querystring"),reducer=require("./helpers/reducer"),targets=require("./targets"),url=require("url"),util=require("util"),validate=require("har-validator/lib/async"),HTTPSnippet=function(e){var t=this,r=util._extend({},e);t.requests=[],(r.log&&r.log.entries?r.log.entries:[{request:r}]).forEach(function(e){e.request.httpVersion=e.request.httpVersion||"HTTP/1.1",e.request.queryString=e.request.queryString||[],e.request.headers=e.request.headers||[],e.request.cookies=e.request.cookies||[],e.request.postData=e.request.postData||{},e.request.postData.mimeType=e.request.postData.mimeType||"application/octet-stream",e.request.bodySize=0,e.request.headersSize=0,e.request.postData.size=0,validate.request(e.request,function(r,a){if(!a)throw r;t.requests.push(t.prepare(e.request))})})};HTTPSnippet.prototype.prepare=function(e){e.queryObj={},e.headersObj={},e.cookiesObj={},e.allHeaders={},e.postData.jsonObj=!1,e.postData.paramsObj=!1,e.queryString&&e.queryString.length&&(debug("queryString found, constructing queryString pair map"),e.queryObj=e.queryString.reduce(reducer,{})),e.headers&&e.headers.length&&(e.headersObj=e.headers.reduceRight(function(e,t){return e[t.name.toLowerCase()]=t.value,e},{})),e.cookies&&e.cookies.length&&(e.cookiesObj=e.cookies.reduceRight(function(e,t){return e[t.name]=t.value,e},{}));var t=e.cookies.map(function(e){return encodeURIComponent(e.name)+"="+encodeURIComponent(e.value)});switch(t.length&&(e.allHeaders.cookie=t.join("; ")),e.postData.mimeType){case"multipart/mixed":case"multipart/related":case"multipart/form-data":case"multipart/alternative":if(e.postData.text="",e.postData.mimeType="multipart/form-data",e.postData.params){var r=new MultiPartForm;r._boundary="---011000010111000001101001",e.postData.params.forEach(function(e){r.append(e.name,e.value||"",{filename:e.fileName||null,contentType:e.contentType||null})}),r.pipe(es.map(function(t,r){e.postData.text+=t})),e.postData.boundary=r.getBoundary(),e.headersObj["content-type"]="multipart/form-data; boundary="+r.getBoundary()}break;case"application/x-www-form-urlencoded":e.postData.params?(e.postData.paramsObj=e.postData.params.reduce(reducer,{}),e.postData.text=qs.stringify(e.postData.paramsObj)):e.postData.text="";break;case"text/json":case"text/x-json":case"application/json":case"application/x-json":if(e.postData.mimeType="application/json",e.postData.text)try{e.postData.jsonObj=JSON.parse(e.postData.text)}catch(t){debug(t),e.postData.mimeType="text/plain"}}return e.allHeaders=util._extend(e.allHeaders,e.headersObj),e.uriObj=url.parse(e.url,!0,!0),e.queryObj=util._extend(e.queryObj,e.uriObj.query),e.uriObj.query=null,e.uriObj.search=null,e.uriObj.path=e.uriObj.pathname,e.url=url.format(e.uriObj),e.uriObj.query=e.queryObj,e.uriObj.search=qs.stringify(e.queryObj),e.uriObj.search&&(e.uriObj.path=e.uriObj.pathname+"?"+e.uriObj.search),e.fullUrl=url.format(e.uriObj),e},HTTPSnippet.prototype.convert=function(e,t,r){!r&&t&&(r=t);var a=this._matchTarget(e,t);if(a){var s=this.requests.map(function(e){return a(e,r)});return 1===s.length?s[0]:s}return!1},HTTPSnippet.prototype._matchTarget=function(e,t){return!!targets.hasOwnProperty(e)&&("string"==typeof t&&"function"==typeof targets[e][t]?targets[e][t]:targets[e][targets[e].info.default])},module.exports=HTTPSnippet,module.exports.availableTargets=function(){return Object.keys(targets).map(function(e){var t=util._extend({},targets[e].info),r=Object.keys(targets[e]).filter(function(e){return!~["info","index"].indexOf(e)}).map(function(t){return targets[e][t].info});return r.length&&(t.clients=r),t})},module.exports.extname=function(e){return targets[e]?targets[e].info.extname:""};

},{"./helpers/reducer":79,"./targets":90,"debug":48,"event-stream":51,"form-data":55,"har-validator/lib/async":76,"querystring":139,"url":162,"util":166}],82:[function(require,module,exports){
"use strict";module.exports={info:{key:"c",title:"C",extname:".c",default:"libcurl"},libcurl:require("./libcurl")};

},{"./libcurl":83}],83:[function(require,module,exports){
"use strict";var CodeBuilder=require("../../helpers/code-builder");module.exports=function(e,s){var r=new CodeBuilder;r.push("CURL *hnd = curl_easy_init();").blank().push('curl_easy_setopt(hnd, CURLOPT_CUSTOMREQUEST, "%s");',e.method.toUpperCase()).push('curl_easy_setopt(hnd, CURLOPT_URL, "%s");',e.fullUrl);var t=Object.keys(e.headersObj);return t.length&&(r.blank().push("struct curl_slist *headers = NULL;"),t.forEach(function(s){r.push('headers = curl_slist_append(headers, "%s: %s");',s,e.headersObj[s])}),r.push("curl_easy_setopt(hnd, CURLOPT_HTTPHEADER, headers);")),e.allHeaders.cookie&&r.blank().push('curl_easy_setopt(hnd, CURLOPT_COOKIE, "%s");',e.allHeaders.cookie),e.postData.text&&r.blank().push("curl_easy_setopt(hnd, CURLOPT_POSTFIELDS, %s);",JSON.stringify(e.postData.text)),r.blank().push("CURLcode ret = curl_easy_perform(hnd);"),r.join()},module.exports.info={key:"libcurl",title:"Libcurl",link:"http://curl.haxx.se/libcurl/",description:"Simple REST and HTTP API Client for C"};

},{"../../helpers/code-builder":78}],84:[function(require,module,exports){
"use strict";var CodeBuilder=require("../../helpers/code-builder"),Keyword=function(e){this.name=e};Keyword.prototype.toString=function(){return":"+this.name};var File=function(e){this.path=e};File.prototype.toString=function(){return'(clojure.java.io/file "'+this.path+'")'};var jsType=function(e){return void 0!==e?e.constructor.name.toLowerCase():null},objEmpty=function(e){return"object"===jsType(e)&&0===Object.keys(e).length},filterEmpty=function(e){return Object.keys(e).filter(function(t){return objEmpty(e[t])}).forEach(function(t){delete e[t]}),e},padBlock=function(e,t){var r=Array.apply(null,Array(e)).map(function(e){return" "}).join("");return t.replace(/\n/g,"\n"+r)},jsToEdn=function(e){switch(jsType(e)){default:return e.toString();case"string":return'"'+e.replace(/\"/g,'\\"')+'"';case"file":case"keyword":return e.toString();case"null":return"nil";case"regexp":return'#"'+e.source+'"';case"object":var t=Object.keys(e).reduce(function(t,r){return t+":"+r+" "+padBlock(r.length+2,jsToEdn(e[r]))+"\n "},"").trim();return"{"+padBlock(1,t)+"}";case"array":var r=e.reduce(function(e,t){return e+" "+jsToEdn(t)},"").trim();return"["+padBlock(1,r)+"]"}};module.exports=function(e,t){var r=new CodeBuilder(t);if(-1===["get","post","put","delete","patch","head","options"].indexOf(e.method.toLowerCase()))return r.push("Method not supported").join();var n={headers:e.allHeaders,"query-params":e.queryObj};switch(e.postData.mimeType){case"application/json":n["content-type"]=new Keyword("json"),n["form-params"]=e.postData.jsonObj,delete n.headers["content-type"];break;case"application/x-www-form-urlencoded":n["form-params"]=e.postData.paramsObj,delete n.headers["content-type"];break;case"text/plain":n.body=e.postData.text,delete n.headers["content-type"];break;case"multipart/form-data":n.multipart=e.postData.params.map(function(e){return e.fileName&&!e.value?{name:e.name,content:new File(e.fileName)}:{name:e.name,content:e.value}}),delete n.headers["content-type"]}switch(n.headers.accept){case"application/json":n.accept=new Keyword("json"),delete n.headers.accept}return r.push("(require '[clj-http.client :as client])\n"),objEmpty(filterEmpty(n))?r.push('(client/%s "%s")',e.method.toLowerCase(),e.url):r.push('(client/%s "%s" %s)',e.method.toLowerCase(),e.url,padBlock(11+e.method.length+e.url.length,jsToEdn(filterEmpty(n)))),r.join()},module.exports.info={key:"clj_http",title:"clj-http",link:"https://github.com/dakrone/clj-http",description:"An idiomatic clojure http client wrapping the apache client."};

},{"../../helpers/code-builder":78}],85:[function(require,module,exports){
"use strict";module.exports={info:{key:"clojure",title:"Clojure",extname:".clj",default:"clj_http"},clj_http:require("./clj_http")};

},{"./clj_http":84}],86:[function(require,module,exports){
"use strict";module.exports={info:{key:"csharp",title:"C#",extname:".cs",default:"restsharp"},restsharp:require("./restsharp")};

},{"./restsharp":87}],87:[function(require,module,exports){
"use strict";var CodeBuilder=require("../../helpers/code-builder");module.exports=function(e,t){var s=new CodeBuilder;if(-1===["GET","POST","PUT","DELETE","PATCH","HEAD","OPTIONS"].indexOf(e.method.toUpperCase()))return"Method not supported";s.push('var client = new RestClient("%s");',e.fullUrl),s.push("var request = new RestRequest(Method.%s);",e.method.toUpperCase());var r=Object.keys(e.headersObj);return r.length&&r.forEach(function(t){s.push('request.AddHeader("%s", "%s");',t,e.headersObj[t])}),e.cookies.length&&e.cookies.forEach(function(e){s.push('request.AddCookie("%s", "%s");',e.name,e.value)}),e.postData.text&&s.push('request.AddParameter("%s", %s, ParameterType.RequestBody);',e.allHeaders["content-type"],JSON.stringify(e.postData.text)),s.push("IRestResponse response = client.Execute(request);"),s.join()},module.exports.info={key:"restsharp",title:"RestSharp",link:"http://restsharp.org/",description:"Simple REST and HTTP API Client for .NET"};

},{"../../helpers/code-builder":78}],88:[function(require,module,exports){
"use strict";module.exports={info:{key:"go",title:"Go",extname:".go",default:"native"},native:require("./native")};

},{"./native":89}],89:[function(require,module,exports){
"use strict";var util=require("util"),CodeBuilder=require("../../helpers/code-builder");module.exports=function(e,t){var s,r=new CodeBuilder("\t"),l=util._extend({showBoilerplate:!0,checkErrors:!1,printBody:!0,timeout:-1},t),i=l.checkErrors?"err":"_",u=l.showBoilerplate?1:0,n=function(){l.checkErrors&&r.push(u,"if err != nil {").push(u+1,"panic(err)").push(u,"}")};return l.showBoilerplate&&(r.push("package main").blank().push("import (").push(u,'"fmt"'),l.timeout>0&&r.push(u,'"time"'),e.postData.text&&r.push(u,'"strings"'),r.push(u,'"net/http"'),l.printBody&&r.push(u,'"io/ioutil"'),r.push(")").blank().push("func main() {").blank()),l.timeout>0?(s="client",r.push(u,"client := http.Client{").push(u+1,"Timeout: time.Duration(%s * time.Second),",l.timeout).push(u,"}").blank()):s="http.DefaultClient",r.push(u,'url := "%s"',e.fullUrl).blank(),e.postData.text?r.push(u,"payload := strings.NewReader(%s)",JSON.stringify(e.postData.text)).blank().push(u,'req, %s := http.NewRequest("%s", url, payload)',i,e.method).blank():r.push(u,'req, %s := http.NewRequest("%s", url, nil)',i,e.method).blank(),n(),Object.keys(e.allHeaders).length&&(Object.keys(e.allHeaders).forEach(function(t){r.push(u,'req.Header.Add("%s", "%s")',t,e.allHeaders[t])}),r.blank()),r.push(u,"res, %s := %s.Do(req)",i,s),n(),l.printBody&&(r.blank().push(u,"defer res.Body.Close()").push(u,"body, %s := ioutil.ReadAll(res.Body)",i),n()),r.blank().push(u,"fmt.Println(res)"),l.printBody&&r.push(u,"fmt.Println(string(body))"),l.showBoilerplate&&r.blank().push("}"),r.join()},module.exports.info={key:"native",title:"NewRequest",link:"http://golang.org/pkg/net/http/#NewRequest",description:"Golang HTTP client request"};

},{"../../helpers/code-builder":78,"util":166}],90:[function(require,module,exports){
"use strict";module.exports={c:require("./c"),clojure:require("./clojure"),csharp:require("./csharp"),go:require("./go"),java:require("./java"),javascript:require("./javascript"),node:require("./node"),objc:require("./objc"),ocaml:require("./ocaml"),php:require("./php"),powershell:require("./powershell"),python:require("./python"),ruby:require("./ruby"),shell:require("./shell"),swift:require("./swift")};

},{"./c":82,"./clojure":85,"./csharp":86,"./go":88,"./java":91,"./javascript":94,"./node":97,"./objc":102,"./ocaml":105,"./php":110,"./powershell":111,"./python":113,"./ruby":116,"./shell":120,"./swift":123}],91:[function(require,module,exports){
"use strict";module.exports={info:{key:"java",title:"Java",extname:".java",default:"unirest"},okhttp:require("./okhttp"),unirest:require("./unirest")};

},{"./okhttp":92,"./unirest":93}],92:[function(require,module,exports){
...
},{"../../helpers/code-builder":78,"util":166}],93:[function(require,module,exports){
"use strict";var util=require("util"),CodeBuilder=require("../../helpers/code-builder");module.exports=function(e,t){var s=util._extend({indent:"  "},t),r=new CodeBuilder(s.indent);-1===["GET","POST","PUT","DELETE","PATCH","HEAD","OPTIONS"].indexOf(e.method.toUpperCase())?r.push('HttpResponse<String> response = Unirest.customMethod("%s","%s")',e.method.toUpperCase(),e.fullUrl):r.push('HttpResponse<String> response = Unirest.%s("%s")',e.method.toLowerCase(),e.fullUrl);var i=Object.keys(e.allHeaders);return i.length&&i.forEach(function(t){r.push(1,'.header("%s", "%s")',t,e.allHeaders[t])}),e.postData.text&&r.push(1,".body(%s)",JSON.stringify(e.postData.text)),r.push(1,".asString();"),r.join()},module.exports.info={key:"unirest",title:"Unirest",link:"http://unirest.io/java.html",description:"Lightweight HTTP Request Client Library"};

},{"../../helpers/code-builder":78,"util":166}],94:[function(require,module,exports){
"use strict";module.exports={info:{key:"javascript",title:"JavaScript",extname:".js",default:"xhr"},jquery:require("./jquery"),xhr:require("./xhr")};

},{"./jquery":95,"./xhr":96}],95:[function(require,module,exports){
"use strict";var util=require("util"),CodeBuilder=require("../../helpers/code-builder");module.exports=function(e,a){var t=util._extend({indent:"  "},a),r=new CodeBuilder(t.indent),s={async:!0,crossDomain:!0,url:e.fullUrl,method:e.method,headers:e.allHeaders};switch(e.postData.mimeType){case"application/x-www-form-urlencoded":s.data=e.postData.paramsObj?e.postData.paramsObj:e.postData.text;break;case"application/json":s.processData=!1,s.data=e.postData.text;break;case"multipart/form-data":r.push("var form = new FormData();"),e.postData.params.forEach(function(e){r.push("form.append(%s, %s);",JSON.stringify(e.name),JSON.stringify(e.value||e.fileName||""))}),s.processData=!1,s.contentType=!1,s.mimeType="multipart/form-data",s.data="[form]",~s.headers["content-type"].indexOf("boundary")&&delete s.headers["content-type"],r.blank();break;default:e.postData.text&&(s.data=e.postData.text)}return r.push("var settings = "+JSON.stringify(s,null,t.indent).replace('"[form]"',"form")).blank().push("$.ajax(settings).done(function (response) {").push(1,"console.log(response);").push("});"),r.join()},module.exports.info={key:"jquery",title:"jQuery",link:"http://api.jquery.com/jquery.ajax/",description:"Perform an asynchronous HTTP (Ajax) requests with jQuery"};

},{"../../helpers/code-builder":78,"util":166}],96:[function(require,module,exports){
...
},{"../../helpers/code-builder":78,"util":166}],97:[function(require,module,exports){
"use strict";module.exports={info:{key:"node",title:"Node.js",extname:".js",default:"native"},native:require("./native"),request:require("./request"),unirest:require("./unirest")};

},{"./native":98,"./request":99,"./unirest":100}],98:[function(require,module,exports){
...
},{"./curl":106,"./http1":108,"./http2":109}],111:[function(require,module,exports){
"use strict";module.exports={info:{key:"powershell",title:"Powershell",extname:".ps1",default:"webrequest"},webrequest:require("./webrequest")};

},{"./webrequest":112}],112:[function(require,module,exports){
"use strict";var CodeBuilder=require("../../helpers/code-builder");module.exports=function(e,o){var s=new CodeBuilder;if(-1===["GET","POST","PUT","DELETE","PATCH","HEAD","OPTIONS"].indexOf(e.method.toUpperCase()))return"Method not supported";var t=[],i=Object.keys(e.headersObj);return i.length&&(s.push("$headers=@{}"),i.forEach(function(o){"connection"!==o&&s.push('$headers.Add("%s", "%s")',o,e.headersObj[o])}),t.push("-Headers $headers")),e.cookies.length&&(s.push("$session = New-Object Microsoft.PowerShell.Commands.WebRequestSession"),e.cookies.forEach(function(o){s.push("$cookie = New-Object System.Net.Cookie"),s.push("$cookie.Name = '%s'",o.name),s.push("$cookie.Value = '%s'",o.value),s.push("$cookie.Domain = '%s'",e.uriObj.host),s.push("$session.Cookies.Add($cookie)")}),t.push("-WebSession $session")),e.postData.text&&(t.push("-ContentType '"+e.allHeaders["content-type"]+"'"),t.push("-Body '"+e.postData.text+"'")),s.push("$response = Invoke-WebRequest -Uri '%s' -Method %s %s",e.fullUrl,e.method,t.join(" ")),s.join()},module.exports.info={key:"webrequest",title:"Invoke-WebRequest",link:"https://docs.microsoft.com/en-us/powershell/module/Microsoft.PowerShell.Utility/Invoke-WebRequest",description:"Powershell Invoke-WebRequest client"};

},{"../../helpers/code-builder":78}],113:[function(require,module,exports){
...
},{"./python3":114,"./requests":115}],114:[function(require,module,exports){
"use strict";var CodeBuilder=require("../../helpers/code-builder");module.exports=function(e,s){var t=new CodeBuilder;t.push("import http.client").blank(),"https:"===e.uriObj.protocol?t.push('conn = http.client.HTTPSConnection("%s")',e.uriObj.host).blank():t.push('conn = http.client.HTTPConnection("%s")',e.uriObj.host).blank();var n,r=JSON.stringify(e.postData.text);r&&t.push("payload = %s",r).blank();var o=e.allHeaders,h=Object.keys(o).length;if(1===h)for(n in o)t.push("headers = { '%s': \"%s\" }",n,o[n]).blank();else if(h>1){var p=1;for(n in t.push("headers = {"),o)p++!==h?t.push("    '%s': \"%s\",",n,o[n]):t.push("    '%s': \"%s\"",n,o[n]);t.push("    }").blank()}var a=e.method,u=e.uriObj.path;return r&&h?t.push('conn.request("%s", "%s", payload, headers)',a,u):r&&!h?t.push('conn.request("%s", "%s", payload)',a,u):!r&&h?t.push('conn.request("%s", "%s", headers=headers)',a,u):t.push('conn.request("%s", "%s")',a,u),t.blank().push("res = conn.getresponse()").push("data = res.read()").blank().push('print(data.decode("utf-8"))'),t.join()},module.exports.info={key:"python3",title:"http.client",link:"https://docs.python.org/3/library/http.client.html",description:"Python3 HTTP Client"};

},{"../../helpers/code-builder":78}],115:[function(require,module,exports){
"use strict";var util=require("util"),CodeBuilder=require("../../helpers/code-builder");module.exports=function(e,s){var r=new CodeBuilder("    ");if(r.push("import requests").blank(),r.push('url = "%s"',e.url).blank(),e.queryString.length){var t="querystring = "+JSON.stringify(e.queryObj);r.push(t).blank()}var u,a=JSON.stringify(e.postData.text);a&&r.push("payload = %s",a);var i=e.allHeaders,l=Object.keys(i).length;if(1===l)for(u in i)r.push("headers = {'%s': '%s'}",u,i[u]).blank();else if(l>1){var n=1;for(u in r.push("headers = {"),i)n++!==l?r.push(1,"'%s': \"%s\",",u,i[u]):r.push(1,"'%s': \"%s\"",u,i[u]);r.push(1,"}").blank()}var p=e.method,o=util.format('response = requests.request("%s", url',p);return a&&(o+=", data=payload"),l>0&&(o+=", headers=headers"),t&&(o+=", params=querystring"),o+=")",r.push(o).blank().push("print(response.text)"),r.join()},module.exports.info={key:"requests",title:"Requests",link:"http://docs.python-requests.org/en/latest/api/#requests.request",description:"Requests HTTP library"};

},{"../../helpers/code-builder":78,"util":166}],116:[function(require,module,exports){
"use strict";module.exports={info:{key:"ruby",title:"Ruby",extname:".rb",default:"native"},native:require("./native")};

},{"./native":117}],117:[function(require,module,exports){
...
},{"../../helpers/code-builder":78}],118:[function(require,module,exports){
"use strict";var util=require("util"),helpers=require("../../helpers/shell"),CodeBuilder=require("../../helpers/code-builder");module.exports=function(e,t){var s=util._extend({indent:"  ",short:!1,binary:!1},t),a=new CodeBuilder(s.indent,!1!==s.indent?" \\\n"+s.indent:" ");switch(a.push("curl %s %s",s.short?"-X":"--request",e.method).push(util.format("%s%s",s.short?"":"--url ",helpers.quote(e.fullUrl))),"HTTP/1.0"===e.httpVersion&&a.push(s.short?"-0":"--http1.0"),Object.keys(e.headersObj).sort().forEach(function(t){var r=util.format("%s: %s",t,e.headersObj[t]);a.push("%s %s",s.short?"-H":"--header",helpers.quote(r))}),e.allHeaders.cookie&&a.push("%s %s",s.short?"-b":"--cookie",helpers.quote(e.allHeaders.cookie)),e.postData.mimeType){case"multipart/form-data":e.postData.params.map(function(e){var t=util.format("%s=%s",e.name,e.value);e.fileName&&!e.value&&(t=util.format("%s=@%s",e.name,e.fileName)),a.push("%s %s",s.short?"-F":"--form",helpers.quote(t))});break;case"application/x-www-form-urlencoded":e.postData.params?e.postData.params.map(function(e){a.push("%s %s",s.binary?"--data-binary":s.short?"-d":"--data",helpers.quote(util.format("%s=%s",e.name,e.value)))}):a.push("%s %s",s.binary?"--data-binary":s.short?"-d":"--data",helpers.escape(helpers.quote(e.postData.text)));break;default:e.postData.text&&a.push("%s %s",s.binary?"--data-binary":s.short?"-d":"--data",helpers.escape(helpers.quote(e.postData.text)))}return a.join()},module.exports.info={key:"curl",title:"cURL",link:"http://curl.haxx.se/",description:"cURL is a command line tool and library for transferring data with URL syntax"};

},{"../../helpers/code-builder":78,"../../helpers/shell":80,"util":166}],119:[function(require,module,exports){
"use strict";var util=require("util"),shell=require("../../helpers/shell"),CodeBuilder=require("../../helpers/code-builder");module.exports=function(t,e){var s=util._extend({body:!1,cert:!1,headers:!1,indent:"  ",pretty:!1,print:!1,queryParams:!1,short:!1,style:!1,timeout:!1,verbose:!1,verify:!1},e),r=new CodeBuilder(s.indent,!1!==s.indent?" \\\n"+s.indent:" "),o=!1,u=[];(s.headers&&u.push(s.short?"-h":"--headers"),s.body&&u.push(s.short?"-b":"--body"),s.verbose&&u.push(s.short?"-v":"--verbose"),s.print&&u.push(util.format("%s=%s",s.short?"-p":"--print",s.print)),s.verify&&u.push(util.format("--verify=%s",s.verify)),s.cert&&u.push(util.format("--cert=%s",s.cert)),s.pretty&&u.push(util.format("--pretty=%s",s.pretty)),s.style&&u.push(util.format("--style=%s",s.pretty)),s.timeout&&u.push(util.format("--timeout=%s",s.timeout)),s.queryParams)&&Object.keys(t.queryObj).forEach(function(e){var s=t.queryObj[e];util.isArray(s)?s.forEach(function(t){r.push("%s==%s",e,shell.quote(t))}):r.push("%s==%s",e,shell.quote(s))});return Object.keys(t.allHeaders).sort().forEach(function(e){r.push("%s:%s",e,shell.quote(t.allHeaders[e]))}),"application/x-www-form-urlencoded"===t.postData.mimeType?t.postData.params&&t.postData.params.length&&(u.push(s.short?"-f":"--form"),t.postData.params.forEach(function(t){r.push("%s=%s",t.name,shell.quote(t.value))})):o=!0,r.unshift("http %s%s %s",u.length?u.join(" ")+" ":"",t.method,shell.quote(s.queryParams?t.url:t.fullUrl)),o&&t.postData.text&&r.unshift("echo %s | ",shell.quote(t.postData.text)),r.join()},module.exports.info={key:"httpie",title:"HTTPie",link:"http://httpie.org/",description:"a CLI, cURL-like tool for humans"};

},{"../../helpers/code-builder":78,"../../helpers/shell":80,"util":166}],120:[function(require,module,exports){
...
},{"./nsurlsession":124}],124:[function(require,module,exports){
"use strict";var util=require("util"),helpers=require("./helpers"),CodeBuilder=require("../../helpers/code-builder");module.exports=function(e,a){var t=util._extend({indent:"  ",pretty:!0,timeout:"10"},a),s=new CodeBuilder(t.indent),r={hasHeaders:!1,hasBody:!1};if(s.push("import Foundation"),Object.keys(e.allHeaders).length&&(r.hasHeaders=!0,s.blank().push(helpers.literalDeclaration("headers",e.allHeaders,t))),e.postData.text||e.postData.jsonObj||e.postData.params)switch(r.hasBody=!0,e.postData.mimeType){case"application/x-www-form-urlencoded":s.blank().push('let postData = NSMutableData(data: "%s=%s".data(using: String.Encoding.utf8)!)',e.postData.params[0].name,e.postData.params[0].value);for(var n=1,p=e.postData.params.length;n<p;n++)s.push('postData.append("&%s=%s".data(using: String.Encoding.utf8)!)',e.postData.params[n].name,e.postData.params[n].value);break;case"application/json":e.postData.jsonObj&&s.push(helpers.literalDeclaration("parameters",e.postData.jsonObj,t),"as [String : Any]").blank().push("let postData = JSONSerialization.data(withJSONObject: parameters, options: [])");break;case"multipart/form-data":s.push(helpers.literalDeclaration("parameters",e.postData.params,t)).blank().push('let boundary = "%s"',e.postData.boundary).blank().push('var body = ""').push("var error: NSError? = nil").push("for param in parameters {").push(1,'let paramName = param["name"]!').push(1,'body += "--\\(boundary)\\r\\n"').push(1,'body += "Content-Disposition:form-data; name=\\"\\(paramName)\\""').push(1,'if let filename = param["fileName"] {').push(2,'let contentType = param["content-type"]!').push(2,"let fileContent = String(contentsOfFile: filename, encoding: String.Encoding.utf8)").push(2,"if (error != nil) {").push(3,"print(error)").push(2,"}").push(2,'body += "; filename=\\"\\(filename)\\"\\r\\n"').push(2,'body += "Content-Type: \\(contentType)\\r\\n\\r\\n"').push(2,"body += fileContent").push(1,'} else if let paramValue = param["value"] {').push(2,'body += "\\r\\n\\r\\n\\(paramValue)"').push(1,"}").push("}");break;default:s.blank().push('let postData = NSData(data: "%s".data(using: String.Encoding.utf8)!)',e.postData.text)}return s.blank().push('let request = NSMutableURLRequest(url: NSURL(string: "%s")! as URL,',e.fullUrl).push("                                        cachePolicy: .useProtocolCachePolicy,").push("                                    timeoutInterval: %s)",parseInt(t.timeout,10).toFixed(1)).push('request.httpMethod = "%s"',e.method),r.hasHeaders&&s.push("request.allHTTPHeaderFields = headers"),r.hasBody&&s.push("request.httpBody = postData as Data"),s.blank().push("let session = URLSession.shared").push("let dataTask = session.dataTask(with: request as URLRequest, completionHandler: { (data, response, error) -> Void in").push(1,"if (error != nil) {").push(2,"print(error)").push(1,"} else {").push(2,"let httpResponse = response as? HTTPURLResponse").push(2,"print(httpResponse)").push(1,"}").push("})").blank().push("dataTask.resume()"),s.join()},module.exports.info={key:"nsurlsession",title:"NSURLSession",link:"https://developer.apple.com/library/mac/documentation/Foundation/Reference/NSURLSession_class/index.html",description:"Foundation's NSURLSession request"};

},{"../../helpers/code-builder":78,"./helpers":122,"util":166}],125:[function(require,module,exports){
...
},{"_process":135,"stream":156}],131:[function(require,module,exports){
...
(function (global){
!function(e){if("object"==typeof exports&&"undefined"!=typeof module)module.exports=e();else if("function"==typeof define&&define.amd)define([],e);else{("undefined"!=typeof window?window:"undefined"!=typeof global?global:"undefined"!=typeof self?self:this).OpenAPISampler=e()}}(function(){return function e(r,t,n){function i(o,u){if(!t[o]){if(!r[o]){var l="function"==typeof require&&require;if(!u&&l)return l(o,!0);if(a)return a(o,!0);var s=new Error("Cannot find module '"+o+"'");throw s.code="MODULE_NOT_FOUND",s}var f=t[o]={exports:{}};r[o][0].call(f.exports,function(e){var t=r[o][1][e];return i(t||e)},f,f.exports,e,r,t,n)}return t[o].exports}for(var a="function"==typeof require&&require,o=0;o<n.length;o++)i(n[o]);return i}({1:[function(e,r,t){var n=Object.prototype.hasOwnProperty,i=Object.prototype.toString;r.exports=function(e,r,t){if("[object Function]"!==i.call(r))throw new TypeError("iterator must be a function");var a=e.length;if(a===+a)for(var o=0;o<a;o++)r.call(t,e[o],o,e);else for(var u in e)n.call(e,u)&&r.call(t,e[u],u,e)}},{}],2:[function(e,r,t){"use strict";var n=e("foreach");function i(e,r,t){if(3===arguments.length)return i.set(e,r,t);if(2===arguments.length)return i.get(e,r);var n=i.bind(i,e);for(var a in i)i.hasOwnProperty(a)&&(n[a]=i[a].bind(n,e));return n}r.exports=i,i.get=function(e,r){for(var t=Array.isArray(r)?r:i.parse(r),n=0;n<t.length;++n){var a=t[n];if(!("object"==typeof e&&a in e))throw new Error("Invalid reference token: "+a);e=e[a]}return e},i.set=function(e,r,t){for(var n=Array.isArray(r)?r:i.parse(r),a=n[0],o=0;o<n.length-1;++o){var u=n[o];"-"===u&&Array.isArray(e)&&(u=e.length),a=n[o+1],u in e||(a.match(/^(\d+|-)$/)?e[u]=[]:e[u]={}),e=e[u]}return"-"===a&&Array.isArray(e)&&(a=e.length),e[a]=t,this},i.remove=function(e,r){var t=Array.isArray(r)?r:i.parse(r),n=t[t.length-1];if(void 0===n)throw new Error('Invalid JSON pointer for remove: "'+r+'"');var a=i.get(e,t.slice(0,-1));if(Array.isArray(a)){var o=+n;if(""===n&&isNaN(o))throw new Error('Invalid array index: "'+n+'"');Array.prototype.splice.call(a,o,1)}else delete a[n]},i.dict=function(e,r){var t={};return i.walk(e,function(e,r){t[r]=e},r),t},i.walk=function(e,r,t){var a=[];t=t||function(e){var r=Object.prototype.toString.call(e);return"[object Object]"===r||"[object Array]"===r},function e(o){n(o,function(n,o){a.push(String(o)),t(n)?e(n):r(n,i.compile(a)),a.pop()})}(e)},i.has=function(e,r){try{i.get(e,r)}catch(e){return!1}return!0},i.escape=function(e){return e.toString().replace(/~/g,"~0").replace(/\//g,"~1")},i.unescape=function(e){return e.replace(/~1/g,"/").replace(/~0/g,"~")},i.parse=function(e){if(""===e)return[];if("/"!==e.charAt(0))throw new Error("Invalid JSON pointer: "+e);return e.substring(1).split(/\//).map(i.unescape)},i.compile=function(e){return 0===e.length?"":"/"+e.map(i.escape).join("/")}},{foreach:1}],3:[function(e,r,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=Object.assign||function(e){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])}return e};t.allOfSample=function(e,r,t,o){var u=(0,i.traverse)(e,t,o),l=[],s=!0,f=!1,c=void 0;try{for(var p,m=r[Symbol.iterator]();!(s=(p=m.next()).done);s=!0){var y=p.value,v=(0,i.traverse)(n({type:d},y),t,o),d=v.type,b=v.readOnly,g=v.writeOnly,h=v.value;if(u.type&&d&&d!==u.type)throw new Error("allOf: schemas with different types can't be merged");u.type=u.type||d,u.readOnly=u.readOnly||b,u.writeOnly=u.writeOnly||g,null!=h&&l.push(h)}}catch(e){f=!0,c=e}finally{try{!s&&m.return&&m.return()}finally{if(f)throw c}}if("object"===u.type)return u.value=a.mergeDeep.apply(void 0,[u.value||{}].concat(l)),u;"array"===u.type&&console.warn('OpenAPI Sampler: found allOf with "array" type. Result may be incorrect');var O=l[l.length-1];return u.value=null!=O?O:u.value,u};var i=e("./traverse"),a=e("./utils")},{"./traverse":12,"./utils":13}],4:[function(e,r,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.inferType=function(e){if(void 0!==e.type)return e.type;for(var r=Object.keys(n),t=0;t<r.length;t++){var i=r[t],a=n[i];if(void 0!==e[i])return a}return null};var n={multipleOf:"number",maximum:"number",exclusiveMaximum:"number",minimum:"number",exclusiveMinimum:"number",maxLength:"string",minLength:"string",pattern:"string",items:"array",maxItems:"array",minItems:"array",uniqueItems:"array",additionalItems:"array",maxProperties:"object",minProperties:"object",required:"object",additionalProperties:"object",properties:"object",patternProperties:"object",dependencies:"object"}},{}],5:[function(e,r,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.inferType=t._samplers=void 0,t.sample=function(e,r,t){var n=Object.assign({},u,r);return(0,i.clearCache)(),(0,i.traverse)(e,n,t).value},t._registerSampler=l;var n=e("./infer");Object.defineProperty(t,"inferType",{enumerable:!0,get:function(){return n.inferType}});var i=e("./traverse"),a=e("./samplers/index"),o=t._samplers={},u={skipReadOnly:!1};function l(e,r){o[e]=r}l("array",a.sampleArray),l("boolean",a.sampleBoolean),l("integer",a.sampleNumber),l("number",a.sampleNumber),l("object",a.sampleObject),l("string",a.sampleString)},{"./infer":4,"./samplers/index":8,"./traverse":12}],6:[function(e,r,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.sampleArray=function(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},t=arguments[2],i=e.minItems||1;Array.isArray(e.items)&&(i=Math.max(i,e.items.length));var a=function(r){return Array.isArray(e.items)?e.items[r]||{}:e.items||{}},o=[];if(!e.items)return o;for(var u=0;u<i;u++){var l=a(u),s=(0,n.traverse)(l,r,t),f=s.value;o.push(f)}return o};var n=e("../traverse")},{"../traverse":12}],7:[function(e,r,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.sampleBoolean=function(e){return!0}},{}],8:[function(e,r,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=e("./array");Object.defineProperty(t,"sampleArray",{enumerable:!0,get:function(){return n.sampleArray}});var i=e("./boolean");Object.defineProperty(t,"sampleBoolean",{enumerable:!0,get:function(){return i.sampleBoolean}});var a=e("./number");Object.defineProperty(t,"sampleNumber",{enumerable:!0,get:function(){return a.sampleNumber}});var o=e("./object");Object.defineProperty(t,"sampleObject",{enumerable:!0,get:function(){return o.sampleObject}});var u=e("./string");Object.defineProperty(t,"sampleString",{enumerable:!0,get:function(){return u.sampleString}})},{"./array":6,"./boolean":7,"./number":9,"./object":10,"./string":11}],9:[function(e,r,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.sampleNumber=function(e){var r=void 0;if(e.maximum&&e.minimum)return r=e.exclusiveMinimum?Math.floor(e.minimum)+1:e.minimum,(e.exclusiveMaximum&&r>=e.maximum||!e.exclusiveMaximum&&r>e.maximum)&&(r=(e.maximum+e.minimum)/2),r;if(e.minimum)return e.exclusiveMinimum?Math.floor(e.minimum)+1:e.minimum;if(e.maximum)return e.exclusiveMaximum?e.maximum>0?0:Math.floor(e.maximum)-1:e.maximum>0?0:e.maximum;return 0}},{}],10:[function(e,r,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};t.sampleObject=function(e){var r=arguments.length>1&&void 0!==arguments[1]?arguments[1]:{},t=arguments[2],a={};if(e&&"object"===n(e.properties)){var o=Array.isArray(e.required)?e.required:[],u=o.reduce(function(e,r){return e[r]=!0,e},{});Object.keys(e.properties).forEach(function(n){if(!r.skipNonRequired||u.hasOwnProperty(n)){var o=(0,i.traverse)(e.properties[n],r,t);r.skipReadOnly&&o.readOnly||r.skipWriteOnly&&o.writeOnly||(a[n]=o.value)}})}e&&"object"===n(e.additionalProperties)&&(a.property1=(0,i.traverse)(e.additionalProperties,r,t).value,a.property2=(0,i.traverse)(e.additionalProperties,r,t).value);return a};var i=e("../traverse")},{"../traverse":12}],11:[function(e,r,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0}),t.sampleString=function(e){var r=e.format||"default";return(u[r]||o)(0|e.minLength,e.maxLength)};var n=e("../utils"),i="qwerty!@#$%^123456";function a(e,r,t){var i=(0,n.toRFCDateTime)(new Date,t,!1);if(i.length<e)throw new Error("Using minLength = "+e+' is incorrect with format "date-time"');if(r&&i.length>r)throw new Error("Using maxLength = "+r+' is incorrect with format "date-time"');return i}function o(e,r){var t=(0,n.ensureMinLength)("string",e);return r&&t.length>r&&(t=t.substring(0,r)),t}var u={email:function(){return"user@example.com"},password:function(e,r){var t="pa$$word";return e>t.length&&(t+="_",t+=(0,n.ensureMinLength)(i,e-t.length).substring(0,e-t.length)),t},"date-time":function(e,r){return a(e,r)},date:function(e,r){return a(e,r,!0)},ipv4:function(){return"192.168.0.1"},ipv6:function(){return"2001:0db8:85a3:0000:0000:8a2e:0370:7334"},hostname:function(){return"example.com"},uri:function(){return"http://example.com"},default:o}},{"../utils":13}],12:[function(e,r,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n=Object.assign||function(e){for(var r=1;r<arguments.length;r++){var t=arguments[r];for(var n in t)Object.prototype.hasOwnProperty.call(t,n)&&(e[n]=t[n])}return e};t.clearCache=function(){f={}},t.traverse=function e(r,t,i){if(r.$ref){if(!i)throw new Error("Your schema contains $ref. You must provide specification in the third parameter.");var l=decodeURIComponent(r.$ref);l.startsWith("#")&&(l=l.substring(1));var c=s.default.get(i,l),p=void 0;if(!0!==f[l])f[l]=!0,p=e(c,t,i),f[l]=!1;else{var m=(0,u.inferType)(c);p={value:"object"===m?{}:"array"===m?[]:void 0}}return p}if(void 0!==r.example)return{value:r.example,readOnly:r.readOnly,writeOnly:r.writeOnly,type:r.type};if(void 0!==r.allOf)return(0,o.allOfSample)(n({},r,{allOf:void 0}),r.allOf,t,i);if(r.oneOf&&r.oneOf.length)return r.anyOf&&console.warn("oneOf and anyOf are not supported on the same level. Skipping anyOf"),e(r.oneOf[0],t,i);if(r.anyOf&&r.anyOf.length)return e(r.anyOf[0],t,i);var y=null;var v=null;if(void 0!==r.default)y=r.default;else if(void 0!==r.enum&&r.enum.length)y=r.enum[0];else{(v=r.type)||(v=(0,u.inferType)(r));var d=a._samplers[v];d&&(y=d(r,t,i))}return{value:y,readOnly:r.readOnly,writeOnly:r.writeOnly,type:v}};var i,a=e("./openapi-sampler"),o=e("./allOf"),u=e("./infer"),l=e("json-pointer"),s=(i=l)&&i.__esModule?i:{default:i};var f={}},{"./allOf":3,"./infer":4,"./openapi-sampler":5,"json-pointer":2}],13:[function(e,r,t){"use strict";Object.defineProperty(t,"__esModule",{value:!0});var n="function"==typeof Symbol&&"symbol"==typeof Symbol.iterator?function(e){return typeof e}:function(e){return e&&"function"==typeof Symbol&&e.constructor===Symbol&&e!==Symbol.prototype?"symbol":typeof e};function i(e){return e<10?"0"+e:e}t.toRFCDateTime=function(e,r,t){var n=e.getUTCFullYear()+"-"+i(e.getUTCMonth()+1)+"-"+i(e.getUTCDate());r||(n+="T"+i(e.getUTCHours())+":"+i(e.getUTCMinutes())+":"+i(e.getUTCSeconds())+(t?"."+(e.getUTCMilliseconds()/1e3).toFixed(3).slice(2,5):"")+"Z");return n},t.ensureMinLength=function(e,r){if(r>e.length)return e.repeat(Math.trunc(r/e.length)+1).substring(0,r);return e},t.mergeDeep=function e(){var r=function(e){return e&&"object"===(void 0===e?"undefined":n(e))};for(var t=arguments.length,i=Array(t),a=0;a<t;a++)i[a]=arguments[a];return i.reduce(function(t,n){return Object.keys(n).forEach(function(i){var a=t[i],o=n[i];r(a)&&r(o)?t[i]=e(a,o):t[i]=o}),t},Array.isArray(i[i.length-1])?[]:{})}},{}]},{},[5])(5)});

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{}],133:[function(require,module,exports){
module.exports=require("through");

},{"through":159}],134:[function(require,module,exports){
(function (process){
...
},{"./_stream_readable":143,"./_stream_writable":145,"core-util-is":47,"inherits":126,"process-nextick-args":134}],142:[function(require,module,exports){
...
},{"./_stream_transform":144,"core-util-is":47,"inherits":126}],143:[function(require,module,exports){
...
},{"./_stream_duplex":141,"./internal/streams/BufferList":146,"./internal/streams/destroy":147,"./internal/streams/stream":148,"_process":135,"core-util-is":47,"events":52,"inherits":126,"isarray":128,"process-nextick-args":134,"safe-buffer":154,"string_decoder/":149,"util":45}],144:[function(require,module,exports){
...
},{"./_stream_duplex":141,"core-util-is":47,"inherits":126}],145:[function(require,module,exports){
...
},{"./_stream_duplex":141,"./internal/streams/destroy":147,"./internal/streams/stream":148,"_process":135,"core-util-is":47,"inherits":126,"process-nextick-args":134,"safe-buffer":154,"timers":160,"util-deprecate":164}],146:[function(require,module,exports){
...
},{"safe-buffer":154,"util":45}],147:[function(require,module,exports){
...
},{"process-nextick-args":134}],148:[function(require,module,exports){
module.exports=require("events").EventEmitter;

},{"events":52}],149:[function(require,module,exports){
...
},{"safe-buffer":154}],150:[function(require,module,exports){
...
},{"buffer":46}],155:[function(require,module,exports){
...
},{"string_decoder":158,"through":159}],156:[function(require,module,exports){
...
},{"events":52,"inherits":126,"readable-stream/duplex.js":140,"readable-stream/passthrough.js":150,"readable-stream/readable.js":151,"readable-stream/transform.js":152,"readable-stream/writable.js":153}],157:[function(require,module,exports){
...
},{"duplexer":50}],158:[function(require,module,exports){
"use strict";var Buffer=require("safe-buffer").Buffer,isEncoding=Buffer.isEncoding||function(t){switch((t=""+t)&&t.toLowerCase()){case"hex":case"utf8":case"utf-8":case"ascii":case"binary":case"base64":case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":case"raw":return!0;default:return!1}};function _normalizeEncoding(t){if(!t)return"utf8";for(var e;;)switch(t){case"utf8":case"utf-8":return"utf8";case"ucs2":case"ucs-2":case"utf16le":case"utf-16le":return"utf16le";case"latin1":case"binary":return"latin1";case"base64":case"ascii":case"hex":return t;default:if(e)return;t=(""+t).toLowerCase(),e=!0}}function normalizeEncoding(t){var e=_normalizeEncoding(t);if("string"!=typeof e&&(Buffer.isEncoding===isEncoding||!isEncoding(t)))throw new Error("Unknown encoding: "+t);return e||t}function StringDecoder(t){var e;switch(this.encoding=normalizeEncoding(t),this.encoding){case"utf16le":this.text=utf16Text,this.end=utf16End,e=4;break;case"utf8":this.fillLast=utf8FillLast,e=4;break;case"base64":this.text=base64Text,this.end=base64End,e=3;break;default:return this.write=simpleWrite,void(this.end=simpleEnd)}this.lastNeed=0,this.lastTotal=0,this.lastChar=Buffer.allocUnsafe(e)}function utf8CheckByte(t){return t<=127?0:t>>5==6?2:t>>4==14?3:t>>3==30?4:t>>6==2?-1:-2}function utf8CheckIncomplete(t,e,s){var i=e.length-1;if(i<s)return 0;var n=utf8CheckByte(e[i]);return n>=0?(n>0&&(t.lastNeed=n-1),n):--i<s||-2===n?0:(n=utf8CheckByte(e[i]))>=0?(n>0&&(t.lastNeed=n-2),n):--i<s||-2===n?0:(n=utf8CheckByte(e[i]))>=0?(n>0&&(2===n?n=0:t.lastNeed=n-3),n):0}function utf8CheckExtraBytes(t,e,s){if(128!=(192&e[0]))return t.lastNeed=0,"�";if(t.lastNeed>1&&e.length>1){if(128!=(192&e[1]))return t.lastNeed=1,"�";if(t.lastNeed>2&&e.length>2&&128!=(192&e[2]))return t.lastNeed=2,"�"}}function utf8FillLast(t){var e=this.lastTotal-this.lastNeed,s=utf8CheckExtraBytes(this,t,e);return void 0!==s?s:this.lastNeed<=t.length?(t.copy(this.lastChar,e,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal)):(t.copy(this.lastChar,e,0,t.length),void(this.lastNeed-=t.length))}function utf8Text(t,e){var s=utf8CheckIncomplete(this,t,e);if(!this.lastNeed)return t.toString("utf8",e);this.lastTotal=s;var i=t.length-(s-this.lastNeed);return t.copy(this.lastChar,0,i),t.toString("utf8",e,i)}function utf8End(t){var e=t&&t.length?this.write(t):"";return this.lastNeed?e+"�":e}function utf16Text(t,e){if((t.length-e)%2==0){var s=t.toString("utf16le",e);if(s){var i=s.charCodeAt(s.length-1);if(i>=55296&&i<=56319)return this.lastNeed=2,this.lastTotal=4,this.lastChar[0]=t[t.length-2],this.lastChar[1]=t[t.length-1],s.slice(0,-1)}return s}return this.lastNeed=1,this.lastTotal=2,this.lastChar[0]=t[t.length-1],t.toString("utf16le",e,t.length-1)}function utf16End(t){var e=t&&t.length?this.write(t):"";if(this.lastNeed){var s=this.lastTotal-this.lastNeed;return e+this.lastChar.toString("utf16le",0,s)}return e}function base64Text(t,e){var s=(t.length-e)%3;return 0===s?t.toString("base64",e):(this.lastNeed=3-s,this.lastTotal=3,1===s?this.lastChar[0]=t[t.length-1]:(this.lastChar[0]=t[t.length-2],this.lastChar[1]=t[t.length-1]),t.toString("base64",e,t.length-s))}function base64End(t){var e=t&&t.length?this.write(t):"";return this.lastNeed?e+this.lastChar.toString("base64",0,3-this.lastNeed):e}function simpleWrite(t){return t.toString(this.encoding)}function simpleEnd(t){return t&&t.length?this.write(t):""}exports.StringDecoder=StringDecoder,StringDecoder.prototype.write=function(t){if(0===t.length)return"";var e,s;if(this.lastNeed){if(void 0===(e=this.fillLast(t)))return"";s=this.lastNeed,this.lastNeed=0}else s=0;return s<t.length?e?e+this.text(t,s):this.text(t,s):e||""},StringDecoder.prototype.end=utf8End,StringDecoder.prototype.text=utf8Text,StringDecoder.prototype.fillLast=function(t){if(this.lastNeed<=t.length)return t.copy(this.lastChar,this.lastTotal-this.lastNeed,0,this.lastNeed),this.lastChar.toString(this.encoding,0,this.lastTotal);t.copy(this.lastChar,this.lastTotal-this.lastNeed,0,t.length),this.lastNeed-=t.length};

},{"safe-buffer":154}],159:[function(require,module,exports){
(function (process){
...
},{"_process":135,"stream":156}],160:[function(require,module,exports){
...
},{"process/browser.js":135,"timers":160}],161:[function(require,module,exports){
...
},{"./util":163,"punycode":136,"querystring":139}],163:[function(require,module,exports){
...
},{"./support/isBuffer":165,"_process":135,"inherits":126}],167:[function(require,module,exports){
var OpenAPISampler=require("openapi-sampler"),createHar=function(e,r,t,a){void 0===a&&(a={});var s=getBaseUrl(e),i={method:t.toUpperCase(),url:s+r,headers:getHeadersArray(e,r,t),queryString:getQueryStrings(e,r,t,a),httpVersion:"HTTP/1.1",cookies:[],headersSize:0,bodySize:0},n=getPayload(e,r,t);return n&&(i.postData=n),i},getPayload=function(e,r,t){if(void 0!==e.paths[r][t].parameters)for(var a in e.paths[r][t].parameters){var s=e.paths[r][t].parameters[a];if(void 0!==s.in&&"body"===s.in.toLowerCase()&&void 0!==s.schema)try{const r=OpenAPISampler.sample(s.schema,{skipReadOnly:!0},e);return{mimeType:"application/json",text:JSON.stringify(r)}}catch(e){return console.log(e),null}}if(e.paths[r][t].requestBody&&e.paths[r][t].requestBody.content&&e.paths[r][t].requestBody.content["application/json"]&&e.paths[r][t].requestBody.content["application/json"].schema){const a=OpenAPISampler.sample(e.paths[r][t].requestBody.content["application/json"].schema,{skipReadOnly:!0},e);return{mimeType:"application/json",text:JSON.stringify(a)}}return null},getBaseUrl=function(e){if(e.servers)return e.servers[0].url;var r="";return void 0!==e.schemes?r+=e.schemes[0]:r+="http","/"===e.basePath?r+="://"+e.host:r+="://"+e.host+e.basePath,r},getQueryStrings=function(e,r,t,a){void 0===a&&(a={});var s=[];if(void 0!==e.paths[r][t].parameters)for(var i in e.paths[r][t].parameters){var n=e.paths[r][t].parameters[i];"string"!=typeof n.$ref||/^http/.test(n.$ref)||(n=resolveRef(e,n.$ref)),void 0!==n.in&&"query"===n.in.toLowerCase()&&s.push({name:n.name,value:void 0===a[n.name]?void 0===n.default?"SOME_"+(n.type||n.schema.type).toUpperCase()+"_VALUE":n.default+"":a[n.name]+""})}return s},getHeadersArray=function(e,r,t){var a,s,i,n=[],o=e.paths[r][t];if(void 0!==o.consumes)for(var p in o.consumes){var u=o.consumes[p];n.push({name:"accept",value:u})}if(void 0!==o.produces)for(var c in o.produces){var h=o.produces[c];n.push({name:"content-type",value:h})}if(o.requestBody&&o.requestBody.content)for(const e of Object.keys(o.requestBody.content))n.push({name:"content-type",value:e});if(void 0!==o.parameters)for(var v in o.parameters){var y=o.parameters[v];void 0!==y.in&&"header"===y.in.toLowerCase()&&n.push({name:y.name,value:"SOME_"+(y.type||y.schema.type).toUpperCase()+"_VALUE"})}if(void 0!==o.security)for(var l in o.security){var d=Object.keys(o.security[l])[0],m=e.securityDefinitions?e.securityDefinitions[d]:e.components.securitySchemes[d];switch(m.type.toLowerCase()){case"basic":a=d;break;case"apikey":"header"===m.in&&(s=m);break;case"oauth2":i=d}}else if(void 0!==e.security)for(var f in e.security){var g=Object.keys(e.security[f])[0];switch(e.securityDefinitions[g].type.toLowerCase()){case"basic":a=g;break;case"apikey":"query"===e.securityDefinitions[g].in&&(s=e.securityDefinitions[g]);break;case"oauth2":i=g}}return a?n.push({name:"Authorization",value:"Basic REPLACE_BASIC_AUTH"}):s?n.push({name:s.name,value:"REPLACE_KEY_VALUE"}):i&&n.push({name:"Authorization",value:"Bearer REPLACE_BEARER_TOKEN"}),n},swaggerToHarList=function(e){try{var r=getBaseUrl(e),t=[];for(var a in e.paths)for(var s in e.paths[a]){var i=r+a,n=createHar(e,a,s);t.push({method:s.toUpperCase(),url:i,description:e.paths[a][s].description||"No description available",har:n})}return t}catch(e){console.log(e)}},resolveRef=function(e,r){var t=r.split("/");if(t.length<=1)return{};var a=function(e,r){if(r+1<t.length){var s=r+1;return a(e[t[r]],s)}return e[t[r]]};return a(e,1)};module.exports={getAll:swaggerToHarList,getEndpoint:createHar};

},{"openapi-sampler":132}]},{},[1]);
